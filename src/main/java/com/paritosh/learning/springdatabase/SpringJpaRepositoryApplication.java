...
import com.paritosh.learning.springdatabase.jpa.PersonSpringDataRepository;
...
public class SpringJpaRepositoryApplication implements CommandLineRunner {

	Logger logger = LoggerFactory.getLogger(SpringJpaRepositoryApplication.class);
	...
	public void run(String... args) throws Exception {
		 personJpaRepository.save(new Person("John","New York", new Date())) ;
		logger.info("Person 10001 -> {} ",personJpaRepository.findById(1));
